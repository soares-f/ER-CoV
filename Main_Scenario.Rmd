...
#rus_svm=predict(ensembles[1],newdata=test[,c(1,4:ncol(test))],type="class"),
rus_svm=3,
                             #sbag_svm=predict(ensembles[2],newdata=test[,c(1,4:ncol(test))],type="class"),
sbag_svm=4,
...
Creating a function to refine predictions
```{r refine}
...
for(i in 1:100){
  ...
  # Using vote strategy: create final_predictions data.frame
